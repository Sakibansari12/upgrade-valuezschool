...
class CreateForgotStudentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('forgot_students', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            ...
            $table->string('forgot_student_status');
    ...
    {
        Schema::dropIfExists('forgot_students');
    }
}
