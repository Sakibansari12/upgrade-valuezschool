    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <div class="row">
                    @if ($quiz_title_data)
                        @foreach ($quiz_title_data as $cdata)
                            @php
                            ...
                            <div class="col-xl-4 col-md-6 col-12 px-4">
                                <div class="card">
                                    ...
                                    @endif
                                    <a href="{{ route('student.quiz.question.list', ['quiz_title_id' => $cdata->id]) }}"
                                                    class="btn btn-sm me-2" style="background-color: #00205c; color: #fff;">
                                    <img class="video-btn"
                                        src="{{ url('uploads/quiz') }}/{{ $cdata->quiz_title_image ? $cdata->quiz_title_image : '' }}"
                                        alt="{{ $cdata->quiz_title }}" data-title="{{ $cdata->quiz_title }}" data-bs-toggle="modal"
                                        
                                        data-bs-target="#bs-video-modal{{ $is_demo_content == '#' ? '-demo' : 'test' }}"
                                         
                                        />
                                        </a>
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $cdata->quiz_title }}</h5>
                                        <!-- <div class="mb-10">
                                            <ul class="list-unstyled d-flex justify-content-between align-items-center">
                                                <li><a href="#" class="text-mute hover-primary"><i
                                                            class="fa fa-tag"></i>
                                                        {{ $cdata->quiz_title }}</a></li>
                                                <li>
                    ...
                    @else
                        <div class="col-sm-6">
                            <div class="card card-body">
                                ...
                                <a href="#" class="btn " style="background-color: #00205c; color: #fff;">Go Back</a>
                            </div> <!-- end card-->
                        </div>
                    @endif
                </div>
