            ...
            <div class="me-auto">
                ...
                <div class="d-inline-block align-items-center">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active alignment-text-new" aria-current="page">Add Quiz Category</li>
                    </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-12">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Add New Quiz Category </h4>
                    </div>
                    <!-- /.box-header -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="title" value="{{ old('title') }}" class="form-control" placeholder="Quiz Category">
                                        <p></p>
                                    </div>
                                </div>
                            </div>
