                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page">Edit Quiz Question
                            </li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="col-lg-12 col-12">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Update Quiz Question </h4>
                    </div>
                    <!-- /.box-header -->
                    <form name="studentcreate" id="studentcreate" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="box-body" id="package-container">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="quiz_title" id="quiz_title"
                                            style="width: 100%;">
                                            @foreach ($quiz_title_data as $quiz_title)
                                                <option value="{{ $quiz_title->id }}"
                                                    {{ $quiz_title->id == $quiz_data->quiz_title_id ? 'selected' : '' }}>
                                                    {{ $quiz_title->quiz_title }}</option>
                                            @endforeach
                                        </select>
                                        <p></p>
                                        <input type="hidden" name="quiz_id" id="quiz_id"
                                            value="{{ isset($quiz_data->id) ? $quiz_data->id : '' }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="question_text" id="question_text"
                                            value="{{ $quiz_data->question_text }}" class="form-control"
                                ...
                                <div class="col-md-6 d-none">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="question_audurl" id="question_audurl"
                                            value="{{ $quiz_data->question_audurl }}" class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="question_title" id="question_title" class="form-control" placeholder="Question Text">{{ $quiz_data->question_title }}</textarea>
                                        <p></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="question_url" id="question_url"
                                            value="{{ $quiz_data->question_url }}" class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="old_question_image" name="old_question_image"
                                            class="form-control" placeholder="Question Image" value="{{ $quiz_data->question_image ? $quiz_data->question_image : '' }}">
                                        <img id="imagePreview"
                                            src="{{ url('uploads/quiz') }}/{{ $quiz_data->question_image ? $quiz_data->question_image : '' }}"
                                            width="100px">
                                        <p></p>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                @php $opt_val = json_decode($quiz_data->question_mcq_opt) @endphp
                                @for ($opt = 0; $opt < 4; $opt++)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input name="crct_answer" class="with-gap" type="radio"
                                                id="radio_{{ $opt }}" value="{{ $opt }}"
                                                {{ $opt == $quiz_data->crct_answer ? 'checked' : '' }} />
                                            <label class="form-label" for="radio_{{ $opt }}">Option {{ $opt + 1 }}</label>
                                            <input id="opt_ans_mcq_{{ $opt }}" name="mcq_input_val[]"
                                                class="form-control"
                                                value="{{ isset($opt_val[$opt]) ? $opt_val[$opt] : '' }}">
                                        </div>
                                    </div>
                                @endfor
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="crct_feedback" id="crct_feedback" class="form-control" placeholder="Enter Correct Feedback">{{ $quiz_data->crct_feedback }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label">Incorrect Feedback</label>
                                        <textarea name="incrct_feedback" id="incrct_feedback" class="form-control" placeholder="Enter Incorrect Feedback">{{ $quiz_data->incrct_feedback }}</textarea>
                                    </div>
                                </div>
                            </div>
