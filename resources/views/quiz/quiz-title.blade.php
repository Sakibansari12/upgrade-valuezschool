                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page">Quiz Title</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-actions float-end">
                            <div class="dropdown show">
                                ...
                                <a href="{{ route('quiz-title-add') }}"
                                    class="waves-effect waves-light btn btn-sm btn-outline btn-info mb-5">Add Quiz Title</a>
        ...
        $(function() {
            var table = $('#yajra-table').DataTable({
                ...
                columns: [
                    ...
                    {
                        data: 'quiz_title_image',
                        name: 'quiz_title_image'
                    },
                    {
                        data: 'quiz_title',
                        name: 'quiz_title'
                    ...
                    {
                        data: 'quiz_category_title',
                        name: 'quiz_category_title'
                    },
                    {
                        data: 'status',
                        name: 'status'
