                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page">Quiz Questions</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-actions float-end">
                            <div class="dropdown show">
                                ...
                                <a href="{{ route('quiz-add') }}"
                                    class="waves-effect waves-light btn btn-sm btn-outline btn-info mb-5">Add Quiz Question</a>
