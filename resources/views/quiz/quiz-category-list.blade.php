                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page">Quiz Category</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Quiz Category</h5>
                        <div class="card-actions float-end">
                            <div class="dropdown show">
                                 
                                <a href="{{ route('quiz-category-add') }}"
                                    class="waves-effect waves-light btn btn-sm btn-outline btn-info mb-5">Add Quiz Category</a>
...
$(document).on('click', '#verify_admin_password', function() {
            ...
            $.ajax({
                url: "{{ route('quiz-category-verify') }}",
                type: "POST",
                data: {
               ...
               // var remId = $(this).attr('data-id');
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "{{ route('quiz-category-remove') }}",
                            data: {
                                quiz_id: remId,
                            },
        ...
        $(function() {
            var table = $('#yajra-table').DataTable({
                ...
                columns: [
                    ...
                    {
                        data: 'quiz_categories_image',
                        name: 'quiz_categories_image'
                    },
                    {
                        data: 'title',
                        name: 'title'
