...
<body>
    ...
    <!-- <p>Your School Admin account password of Valuez school 21st Century LMS has been reset</p> -->
    <p>Hello {{ $details['title'] }},</p>
    <p>{{ $details['school_name'] }}</p>
    <p>Your Valuez school 21st century LMS School Admin account password has been rest. Your user ID continues to be this email ID.</p>
