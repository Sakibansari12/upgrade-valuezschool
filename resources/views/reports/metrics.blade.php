                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page">View Analytics</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">School Module Completion Report</h5>
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="card-actions float-end">
                            <div class="dropdown show">
                                <!-- <a href="{{ route('school.add') }}"
                                    class="waves-effect waves-light btn btn-sm btn-outline btn-info mb-5">Module Access Report</a> -->
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-actions float-end">
                                    <div class="dropdown show">
                                        <a href="{{ route('module-access-report-list',['school_id' => $school]) }}"
                                            class="waves-effect waves-light btn btn-sm  mb-5" style="background-color: #00205c; color: #ffff;">Module Access Report</a>
                                    </div>
                                </div>
                            </div>
                        </div>
