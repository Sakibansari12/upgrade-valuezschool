                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page">Invoice</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-actions float-end">
                            <div class="dropdown show">
                                <a href="{{ route('invoice.add') }}"
                                    class="waves-effect waves-light btn btn-sm btn-outline btn-info mb-5">Add Invoice</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
...
$(document).on('click', '#verify_admin_password', function() {
            ...
            $.ajax({
                url: "{{ route('invoice-verify-admin') }}",
                type: "POST",
                data: {
