                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page">Add Invoice</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-12">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Add New Invoice</h4>
                    </div>
                    <!-- /.box-header -->
                    <form id="Invoicecreate" name="Invoicecreate" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="invoice_date" id="invoice_date" class="form-control" placeholder="Invoice Date">
                                        <p></p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cgst" id="cgst" class="form-control" placeholder="Enter CGST">
                                        <p></p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sgst" id="sgst" class="form-control" placeholder="Enter SGST">
                                        <p></p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="igst" id="igst" class="form-control" placeholder="Enter IGST">
                                        <p></p>
                                    </div>
                                </div>
                            </div>
