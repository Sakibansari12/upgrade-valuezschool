...
@section('content')
    ...
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="me-auto">
                <h4 class="page-title"><!-- Test Dally --></h4>
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page">Test Dally</li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="col-xl-8">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title mb-0" style="color: #00205c;"> Test Dally</h2>
                </div>
                <div class="card-body">
                    ...
                    <form name="feedbackemail" id="feedbackemail" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <label for="dally" class="form-label">Dally <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="dally" name="dally" Placeholder="Your Dally" >
                            <p></p>
                        </div>
             ...
             success: function(response){
                if(response['status'] == true){
                   // console.log(response['message']);
                    ...
                    var dally_errors = response['dally_errors'];
                    $('#dally').siblings('p').addClass('text-danger').html(dally_errors);
