            ...
            <div class="me-auto">
                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        ...
                        <li class="breadcrumb-item active alignment-text-new" aria-current="page"><a href="{{ route('subscription-manage-list', ['subscription_id' => $subscriptions->id]) }}"><i class="mdi mdi-home-outline"></i> - Manage</a></li>
                            
                        <li class="breadcrumb-item active alignment-text-new" aria-current="page">Add New Subscription</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <form name="subscriptionsUpdate" id="subscriptionsUpdate" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="package-row">
                            <div class="row">
                                ...
                                @if ($key + 1 == 1)
                                <div class="col-md-4">
                                    <button type="button" class="btn add-fields" style="background-color: #00205c; color: #fff; margin-top: 21px;">Add another license</button>
                                </div>
                                @else
                                <div class="col-md-4">
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response['status'] == true) {
                ...
                var licence_limit = response['licence_limit'];
               // console.log(errors,"errors");
                
               if (licence_limit) {
    Swal.fire({
        title: 'Maximum licenses limit reached.',
        icon: 'warning',
