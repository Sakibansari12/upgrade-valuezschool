                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page"><a href="{{ route('subscription-manage-list', ['subscription_id' => $subscription_data->id]) }}"><i class="mdi mdi-home-outline"></i> - Manage</a></li>
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page">Payment</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Subscription Request Payments List</h5>
                        <!-- <div class="card-actions float-end">
                        </div> -->
                        <div class="card-actions float-end">
                            <div class="dropdown show">
                                    <a href="{{ route('export-sr-school-payment', ['subscription_id' => $subscription_data->id]) }}"
                                        id="export-link"
                                    ...
                                    @foreach ($paymentlists  as $key => $data)
                                        <tr>
                                            ...
                                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                                    ...
                                                    title="Payment Info"><i class="fas fa-info-circle info-icon-payment"></i></a>
                                                    @endif
                                                </td>
...
<!-- <form action="{{ route('school-payment.store') }}" method="POST"> -->
    ...
    <div class="box-body" >
        ...
        <div class="form-group">
            ...
            <input type="number" name="number_of_subscription" value="{{ $subscription_data->package_row_count }}" id="number_of_subscription" class="form-control" placeholder="Number of Subscription">
            <p></p>
            @error('price')
        ...
        <div class="form-group">
            ...
            <input type="text" name="phone_numbers" id="phone_numbers" readonly value="{{$my_phone_number}}" class="form-control" placeholder="Phone Number">
            <p></p>
            @error('phone_numbers')
        ...
        <div class="form-group">
            ...
            <input type="text" name="emails" id="emails" readonly value="{{$my_email}}" class="form-control" placeholder="Email">
            <p></p>
            @error('email')
    ...
    <input type="hidden" name="subscription_id" id="subscription_id" value="{{ $subscription_data->id }}">
...
function DeactivatePaymentLink() {
   ...
   /*  $('#sent_email_payment_link').submit(function (event) { */
    ...
    if (isValid) {
        ...
        $.ajax({
            url: '{{ route("sr-sent-email-payment-link") }}',
            type: 'post',
            data: data,
            dataType: 'json',
            success: function (response) {
                if (response['status'] == true) {
                    window.location.href="{{  route('subscription-request-payment',['subscription_id' => $subscription_data->id]) }}";
                    // Redirect to another page or perform further actions
                } else {
                    var errors = response['errors'];
                    console.log(errors, "errors");
   ...
   $('#studentcreate').submit(function (event) {
    ...
    $.ajax({
        url: '{{ route("subscription-request-payment-store") }}',
        type: 'post',
        data: data,
        dataType: 'json',
        success: function (response) {
