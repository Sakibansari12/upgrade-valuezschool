                                            ...
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <div class="form-inline-vision">
                                                        <div class="mb-3">
                                                            <label class="form-label">Vision Part <span class="text-danger">*</span></label>
                                                            <div>
                                                                <input type="file" name="vision_image[]" id="vision_generate_vision_0_vision_image"  class="form-control">
                                                                <p></p>
                                                            </div>
                                                            <div>
                                                                <input type="text" name="vision_text[]" id="vision_generate_vision_0_vision_text" placeholder="Enter Text" class="form-control mt-1">
                                                                <p></p>
                                                            </div>
                                                            <div>
                                                            <input type="file" name="vision_music[]" id="vision_generate_vision_0_vision_music"  class="form-control mt-1">
                                                            <p></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <textarea  rows="5" name="own_description" id="own_description" class="form-control"
                                            placeholder="Enter Image Narration Description">{{ old('own_description') }}</textarea>
                                            <p></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-9">
                            <div class="form-inline-vision">
                                <div class="mb-3">
                                    ...
                                    <div>
                                    <input type="file" name="vision_image[]" id="vision_generate_vision_${errorvision}_vision_image"  class="form-control">
                                    <p></p>
                                    </div>
                                    <div>
                                    <input type="text" name="vision_text[]" id="vision_generate_vision_${errorvision}_vision_text" placeholder="Enter Text" class="form-control mt-1">
                                    <p></p>
                                    </div>
                                    <div>
                                    <input type="file" name="vision_music[]" id="vision_generate_vision_${errorvision}_vision_music"  class="form-control mt-1">
                                    <p></p>
                                    </div>
                                </div>
                            </div>
