...
<div class="box-body">
    ...
    <hr>
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <textarea  rows="5" name="own_description" id="own_description" class="form-control"
                                            placeholder="Enter Plant Description">{{ isset($aimoduledata->own_description) ? $aimoduledata->own_description : '' }}</textarea>
                                            <p></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <label class="form-label">Bird Placeholder<span class="text-danger">*</span></label>
                                        <input type="text" name="own_placeholder" value="{{ isset($aimoduledata->own_placeholder) ? $aimoduledata->own_placeholder : '' }}" id="own_placeholder" class="form-control" placeholder="Enter Bird Placeholder">
                                        <p></p>
                                    </div>
                                </div>
                            </div> -->
