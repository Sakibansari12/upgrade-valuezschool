                                ...
                                <div class="row" id="dynamic-fields">
                                    <div class="col-md-9">
                                        <div class="form-inline-Prompts">
                                            <div class="mb-3">
                                                <textarea name="prompts[]" class="form-control " id="content_prompts_0_prompts" rows="4" placeholder="Enter video url"></textarea>
                                              <p></p>
                                            </div>
                                            <div class="mb-3">
    ...
    $("#add-fields").click(function() {
        ...
        $(
            ...
            '<div class="col-md-9">' +
                '<div class="form-inline-Prompts">' +
                    '<div class="mb-3">' +
                      '<textarea name="prompts[]" id="content_prompts_'+ errorprompts +'_prompts" class="form-control" rows="4" placeholder="Enter video url"></textarea>' +
                    '<p></p>' +
                      '</div>' +
                    '<div class="mb-3">' +
