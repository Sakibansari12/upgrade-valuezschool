                                ...
                                <div id="prompts-removie-data" class="row">
                                    <div class="col-md-9">
                                        <div class="form-inline-Prompts">
                                            <div class="mb-3">
                                                <textarea name="prompts[]" class="form-control" rows="4" placeholder="Enter video url">{{ isset($cdata->prompts) ? $cdata->prompts : '' }}</textarea>
                                            </div>
                                            <div class="mb-3">
                            ...
                            <div class="form-group" id="activitie-fields-add">
                                ...
                                <div class="col-md-9">
                                        <div class="form-inline-own-activities">
                                            <div class="mb-3">
                                            <!-- <label class="form-label">Activities Description <span class="text-danger">*</span></label> -->
                                                <textarea name="add_placeholder_text[]" class="form-control" rows="4" placeholder="Activities, own prompt description"></textarea>
                                            </div>
                                            <div class="mb-3">
    ...
    $("#add-fields").click(function() {
        ...
        $(
            '<div class="col-md-9">' +
                '<div class="form-inline-Prompts">' +
                    '<div class="mb-3">' +
                      '<textarea name="prompts[]" class="form-control" rows="4" placeholder="Enter video url"></textarea>' +
                    '</div>' +
                    '<div class="mb-3">' +
