...
$(document).ready(function() {
 ...
 $(document).ready(function() {
   // var fieldCounterpromts = 1;
    ...
    var fieldCounterpromts = $('#dynamic-fields');
    var newPromptscount = fieldCounterpromts.children().length;
   // $('#content_prompts_' + (newPromptscount - 1) + '_prompts').wysihtml5();
   // $('#content_prompts_' + (newPromptscount - 1) + '_response').wysihtml5();

console.log(newPromptscount,"newPromptscount");
    $("#add-fields").click(function() {
        newPromptscount++;
        var newRow = 
        $(
