                    ...
                    <form action="" id="aimodulesupdate" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                ...
                                                <textarea  rows="5" name="description" id="description" class="form-control"
                                                    placeholder="Enter Description">{{ isset($aimoduledata->description) ? $aimoduledata->description : '' }}</textarea>
                                                    <p></p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="prompts-removie-data" class="row">
                                    <div class="col-md-9">
                                        <div class="form-inline-Prompts">
                                            <div class="mb-3">
                                                <textarea name="prompts[]" id="content_prompts_{{$key + 1}}_prompts" class="form-control" rows="4" placeholder="Prompts">{{ isset($cdata->prompts) ? $cdata->prompts : '' }}</textarea>
                                            </div>
                                            <div class="mb-3">
                                                <textarea name="response[]" id="content_prompts_{{$key + 1}}_response" class="form-control" rows="4" placeholder="Response">{{ isset($cdata->response) ? $cdata->response : '' }}</textarea>
                                            </div>
                                            <div class="mb-3">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <label class="form-label">Enter Own Description </label>
                                        <textarea  rows="5" name="own_description" id="own_description" class="form-control"
                                            placeholder="Enter Own Description">{{ isset($aimoduledata->own_description) ? $aimoduledata->own_description : '' }}</textarea>
                                            <p></p>
                                    </div>
                                </div>
                            </div>
    ...
    $("#add-fields").click(function() {
        ...
        $(
            '<div class="col-md-9">' +
                '<div class="form-inline-Prompts">' +
                    '<div class="mb-3">' +
                      '<textarea name="prompts[]" id="content_prompts_' + newPromptscount + '_prompts" class="form-control" rows="4" placeholder="Prompts"></textarea>' +
                    '</div>' +
                    '<div class="mb-3">' +
                      '<textarea name="response[]" id="content_prompts_' + newPromptscount + '_response" class="form-control" rows="4" placeholder="Response"></textarea>' +
                    '</div>' +
                    '<div class="mb-3">' +
