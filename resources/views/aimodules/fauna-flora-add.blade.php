                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="form-inline-hybrid">
                                <div class="mb-3">
                                <label class="form-label">Animal 1 <span class="text-danger">*</span></label>
                                    <input type="file" name="animal_one[]" id="hybrid_generate_hybrid_0_animal_one"  class="form-control">
                                    <p></p>
                                    <input type="text" name="animal_one_name[]" id="hybrid_generate_hybrid_0_animal_one_name" class="form-control mt-1">
                                    <p></p>
                                </div>
                                <div class="mb-3">
                                <label class="form-label">Animal 2 <span class="text-danger">*</span></label>
                                    <input type="file" name="animal_second[]" id="hybrid_generate_hybrid_0_animal_second" class="form-control">
                                    <p></p>
                                    <input type="text" name="animal_second_name[]" id="hybrid_generate_hybrid_0_animal_second_name" class="form-control mt-1">
                                    <p></p>
                                </div>
                                <div class="mb-3">
                                <label class="form-label">Result <span class="text-danger">*</span></label>
                                    <input type="file" name="result[]" id="hybrid_generate_hybrid_0_result" class="form-control">
                                    <p></p>
                                    <input type="text" name="result_name[]" id="hybrid_generate_hybrid_0_result_name" class="form-control mt-1">
                                    <p></p>
                                </div>
                            </div>
                        </div>
            ...
            '<div class="col-md-9">' +
                '<div class="form-inline-own-activities">' +
                    ...
                    '<label class="form-label">Add AI Tool Url <span class="text-danger">*</span></label>' +
                      '<input type="text" name="add_ai_toll_url[]" id="content_add_own_activities_prompts_'+ errorownactivities +'_add_ai_toll_url" class="form-control" placeholder="Activities, own prompt website url ">' +
                      '<p></p>' +
                      '</div>' +
                    '<div class="mb-3">' +
                    '<label class="form-label">Activities, own prompt tool name <span class="text-danger">*</span></label>' +
                    '<input type="text" name="toll_name[]" id="content_add_own_activities_prompts_'+ errorownactivities +'_toll_name" class="form-control" placeholder="Activities, own prompt tool name">' +
                    '<p></p>' +
                    '</div>' +
                '</div>' +
            '</div>' +
                        ...
                        <div class="col-md-9">
                            <div class="form-inline-hybrid">
                                ...
                                <label class="form-label">Animal 1 </label>
                                    <input type="file" name="animal_one[]" id="hybrid_generate_hybrid_${erroranimal}_animal_one" class="form-control">
                                    <p></p>
                                    <input type="text" name="animal_one_name[]" id="hybrid_generate_hybrid_${erroranimal}_animal_one_name" class="form-control mt-1">
                                    <p></p>
                                </div>
                                <div class="mb-3">
                                <label class="form-label">Animal 2 </label>
                                    <input type="file" name="animal_second[]" id="hybrid_generate_hybrid_${erroranimal}_animal_second" class="form-control">
                                    <p></p>
                                    <input type="text" name="animal_second_name[]" id="hybrid_generate_hybrid_${erroranimal}_animal_second_name" class="form-control mt-1">
                                    <p></p>
                                </div>
                                <div class="mb-3">
                                <label class="form-label">Result </label>
                                    <input type="file" name="result[]" id="hybrid_generate_hybrid_${erroranimal}_result" class="form-control">
                                    <p></p>
                                    <input type="text" name="result_name[]" id="hybrid_generate_hybrid_${erroranimal}_result_name" class="form-control mt-1">
                                    <p></p>
                                </div>
                            </div>
                        </div>
