                    ...
                    <form action="" id="aimodulesupdate" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <label class="form-label">Description for "Try the prompts below" <span class="text-danger">*</span></label>
                                ...
                                <div id="prompts-removie-data" class="row">
                                    <div class="col-md-9">
                                        <div class="form-inline-Prompts">
                                            <div class="mb-3">
                                                <textarea name="prompts[]" class="form-control" id="content_prompts_{{$key + 1}}_prompts" rows="4" placeholder="Prompts">{{ isset($cdata->prompts) ? $cdata->prompts : '' }}</textarea>
                                            </div>
                                            <div class="mb-3">
                                                <textarea name="response[]" class="form-control" id="content_prompts_{{$key + 1}}_response" rows="4" placeholder="Response">{{ isset($cdata->response) ? $cdata->response : '' }}</textarea>
                                            </div>
                                            <div class="mb-3">
                                                <input type="file" class="form-control form-control" name="answers_file[]" id="answers_file_{{$key + 1}}">
                        ...
                        <div class="box-body">
                            <div class="form-group" id="activitie-fields-add">
                                ...
                                <div id="prompts-removie-data" class="row">
                                    <div class="col-md-9">
                                        <div class="form-inline-own-activities">
                                            <div class="mb-3">
                                            <!-- <label class="form-label">Activities Description <span class="text-danger">*</span></label> -->
                                                <textarea name="add_placeholder_text[]" class="form-control" rows="4" placeholder="Let's get hands on with AI tools">{{ isset($cdata->add_placeholder_text) ? $cdata->add_placeholder_text : '' }}</textarea>
                                            </div>
                                            <div class="mb-3">
                                ...
                                <div class="col-md-9">
                                        <div class="form-inline-own-activities">
                                            ...
                                            <div class="mb-3">
                                            <label class="form-label">Activities, own prompt website url <span class="text-danger">*</span></label>
                                                <input type="text" name="add_ai_toll_url[]" class="form-control" placeholder="Activities, own prompt website url">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Activities, own prompt tool name <span class="text-danger">*</span></label>
                                                <input type="text" name="toll_name[]" class="form-control" placeholder="Activities, own prompt tool name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <label class="form-label">Description for "Try your own prompts" <span class="text-danger">*</span></label>
                                        <textarea  rows="5" name="own_description" id="own_description" class="form-control"
                                            placeholder="Description for Try your own prompts">{{ isset($aimoduledata->own_description) ? $aimoduledata->own_description : '' }}</textarea>
                                            <p></p>
                                    </div>
                                </div>
                            </div>
                           <!--  <hr>
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <label class="form-label">Enter Own Placeholder<span class="text-danger">*</span></label>
                                        <input type="text" name="own_placeholder" value="{{ isset($aimoduledata->own_placeholder) ? $aimoduledata->own_placeholder : '' }}" id="own_placeholder" class="form-control" placeholder="Enter Own Placeholder">
                                        <p></p>
                                    </div>
                                </div>
                            </div> -->
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <label class="form-label">Hello There Description <span class="text-danger">*</span></label>
...
$(document).ready(function() {
    var fieldCounterpromts = $('#dynamic-fields');
    var newPromptscount = fieldCounterpromts.children().length;

    for (var i = 1; i <= newPromptscount; i++) {
        $('#content_prompts_' + i + '_prompts').wysihtml5();
        $('#content_prompts_' + i + '_response').wysihtml5();
    }
});
 /* prompts */
 $(document).ready(function() {
       ...
       // fieldCounterpromts++;
        ...
        $(
            '<div class="col-md-9">' +
                '<div class="form-inline-Prompts">' +
                    '<div class="mb-3">' +
                      '<textarea name="prompts[]" class="form-control" id="content_prompts_' + newPromptscount + '_prompts" rows="4" placeholder="Prompts"></textarea>' +
                    '</div>' +
                    '<div class="mb-3">' +
                      '<textarea name="response[]" class="form-control" id="content_prompts_' + newPromptscount + '_response" rows="4" placeholder="Response"></textarea>' +
                    '</div>' +
                    '<div class="mb-3">' +
                    '<input type="file" class="form-control form-control" name="answers_file[]" id="answers_file_' + newPromptscount + '">' +
                    '</div>' +
        ...
        $("#dynamic-fields").append(newRow);
        $('#content_prompts_' + newPromptscount + '_prompts').wysihtml5();
        $('#content_prompts_' + newPromptscount + '_response').wysihtml5();
        newRow.find(".remove-field").click(function() {
            newRow.remove();
        });
    });
