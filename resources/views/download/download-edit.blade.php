                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page">Edit Add Image</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-lg-8 col-12">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Update Add Image</h4>
                    </div>
                    <!-- /.box-header -->
                    <form action="{{ route('download-update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <img src="{{ url('uploads/download') }}/{{ $download_data->image ? $download_data->image : 'no_image.png' }}"
                                    width="100px">
                                @error('image')
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="lesson_inst" rows="3" name="description" class="form-control"
                                    placeholder="Description">{{ $download_data->description }}</textarea>
                                @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                                  <div class="form-group">
                                        ...
                                        <select class="form-control" name="school_ids[]" style="width: 100%;"
                                            ...
                                            @foreach ($school_all_data as $school)
                                                @php $schoolIds = ($school_ids)?$school_ids:old('school_ids'); @endphp
                        ...
                        <div class="box-footer">
                            <input type="hidden" name="download_id" value="{{ $download_data->id }}">
                            <input type="hidden" name="old_image" value="{{ $download_data->image }}">
