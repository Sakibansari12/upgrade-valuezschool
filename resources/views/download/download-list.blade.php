                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page"> School Ads</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">School Ads</h5>

                        <div class="d-flex float-end">
                            <!-- <div id="class-filter" class="px-3"></div>
                            <div id="course-filter" class="px-3"></div> -->

                            <a href="{{ route('download-add') }}"
                                class="waves-effect waves-light btn btn-sm btn-outline btn-info mb-5">Add Image
                            </a>
                        </div>
...
$(document).on('click', '#verify_admin_password', function() {
            ...
            $.ajax({
                url: "{{ route('download-verify-admin') }}",
                type: "POST",
                data: {
