...
@section('content')
    ...
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="me-auto">
                <h4 class="page-title">Ad Graphics</h4>
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <div class="row">
                    @if ($download_data->first())
                        @foreach ($download_data as $cdata)
                            @php
                                if (($cdata->status == 1 && $check_premium->is_demo == 1) || $check_premium->is_demo == 0) {
                                    $is_demo_content = 1;
                                    $main_video = url('uploads/download') . '/' . ($cdata->image ? $cdata->image : 'no_image.png');
                                } else {
                            ...
                            <div class="col-xl-4 col-md-6 col-12 px-4">
                                <div class="card">
                                    ...
                                    @endif
                                    <img class="video-btn"
                                        src="{{ url('uploads/download') }}/{{ $cdata->image ? $cdata->image : 'no_image.png' }}"
                                    ...
                                    <div class="card-body">
                                        @if (($cdata->status == 1 && $check_premium->is_demo == 1) || $check_premium->is_demo == 0)
                                            <div class="justify-content-center align-items-center">
                                                ...
                                                @endif
                                                @if ($cdata->description)   
                                                 <a href="{{ url('uploads/download') }}/{{ $cdata->image }}"
                                                   style="background-color: #00205c; color: #fff;" class="btn btn-sm" download>Download</a>
                                                 @endif  
                                            </div>
                                        @else
                    ...
                    @else
                        <div class="col-sm-6">
                            <div class="card card-body">
                                <h5 class="card-title fw-600">Ad Graphic not found.</h5>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="ribbon-box video-close">
                    ...
                    <h5 class="text-danger float-start m-0 p-3" id="video-title">Advertisement Graphic</h5>
                </div>
                <img class="video-btn"  src="" id="video"/>
                <!-- <div class="modal-body pt-0">
                    <div id="video-loader" class="text-center"><i class="fa fa-spinner fa-spin fs-1"></i></div>
                    <div class="ratio ratio-16x9">
                            <img src=""  width="100px" id="video">
                    </div>
                </div> -->
            </div>
        </div>
