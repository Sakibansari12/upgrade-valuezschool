                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page">Add NCF Assessments</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-lg-8 col-12">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Add NCF Assessments</h4>
                    </div>
                    <!-- /.box-header -->
...
$('#healthyMindcreate').submit(function (event) {
   ...
   // formData.append('video_url', $('#video_url').val());
    ...
    $.ajax({
        url: '{{ route("ncf-assessment-store") }}',
        type: 'POST',
        processData: false,
        contentType: false,
        data: formData,
