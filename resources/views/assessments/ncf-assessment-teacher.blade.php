...
@section('content')
    ...
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="me-auto">
                <h4 class="page-title">NCF Assessments</h4>
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <div class="row">
                    @if ($ncf_assessment_data)
                        @foreach ($ncf_assessment_data as $cdata)
                            @php
                            ...
                            <div class="col-xl-4 col-md-6 col-12 px-4">
                                <div class="card">
                                    ...
                                    @endif
                                    <img class="video-btn"
                                        src="{{ url('uploads/ncf_assessment') }}/{{ $cdata->ncf_assessment_image ? $cdata->ncf_assessment_image : 'no_image.png' }}"
                                            ...
                                            <div class="justify-content-center align-items-center">
                                                @if ($cdata->description)
                                                    <button type="button" class="btn btn-info btn-sm mb-6"
                                                        ...
                                                        <a href="{{ url('uploads/ncf_assessment') }}/{{ $cdata->ncf_assessment_file }}"
                                                                        style="background-color: #00205c; color: #fff; "
                                                                        class="btn btn-sm"
                                                                        download>NCF Assessments
                                                                        </a>
                                                @endif                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
                                            </div>
                                        @else
