                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page">Package</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-actions float-end">
                            <div class="dropdown show">
                                 <!-- @if($student_package_count == 0) -->
                                
                               <!--  @endif -->   
                               <a href="{{ route('package.add') }}"
                                    class="waves-effect waves-light btn btn-sm btn-outline btn-info mb-5">Add Package</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
        ...
        $(function() {
            var table = $('#yajra-table').DataTable({
                ...
                columns: [
                    ...
                    {
                        data: 'name_of_package',
                        name: 'name_of_package'
                    },
                    {
                        data: 'duration_of_package',
                        name: 'duration_of_package'
                    },
                    {
                        data: 'set_pricing',
                        name: 'set_pricing'
