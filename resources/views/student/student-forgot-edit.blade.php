                                ...
                                <div class="form-group" id="password_hide">
                                        ...
                                        <div class="controls">
                                            <div class="input-group" id="passwordsibling">
                                                <input type="password" id="password" name="password" value="{{ $studentdata->password}}" class="form-control" placeholder="Password">
...
@section('script-section')
    ...
    $('#studentUpdateForm').submit(function(){
           ...
           $.ajax({
             url: '{{ route("student.update-forgot-password",['student_id' => $studentdata->id]) }}',
             type: 'put',
             data: formArray,
             dataType: 'json',
