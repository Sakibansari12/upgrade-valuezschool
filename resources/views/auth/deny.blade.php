            ...
            <div class="row h-p100 align-items-center justify-content-center text-center">
                <div class="col-lg-7 col-md-10 col-12">
                    <div class="rounded30 p-50">
                        ...
                        <h4 class="text-fade">Please try a different classroom login or logout from the previous device.
                        </h4>
                        <div class="my-30"><a href="{{ route('signout') }}" class="btn btn-primary">Back to
                                Login</a></div>
