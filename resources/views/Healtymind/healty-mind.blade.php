                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page"> Healthy Mind</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Healthy Mind</h5>

                        <div class="d-flex float-end">
                            <!-- <div id="class-filter" class="px-3"></div>
                            <div id="course-filter" class="px-3"></div> -->

                            <a href="{{ route('healty-mind-add') }}"
                                class="waves-effect waves-light btn btn-sm btn-outline btn-info mb-5">Add Healthy Mind
                                Module
                            </a>
                        </div>
...
<script type="text/javascript">
        $(function() {
            ...
            var table = $('#yajra-table').DataTable({
                ...
                pageLength: 50,
                order: [],
                ajax: "{{ route('healty-mind-list') }}",
                columns: [{
                        data: 'healty_mind_image',
                        name: 'healty_mind_image',
                        orderable: false,
                    },
                    {
                        data: 'title',
                    ...
                    {
                        data: 'red_guidance_desc',
                        name: 'red_guidance_desc'
                    },
                    {
                        data: 'video_url',
                        name: 'video_url'
                    ...
                    {
                        data: 'healty_mind_file',
                        name: 'healty_mind_file'
                    },
                    {
                        data: 'status',
                        name: 'status'
...
$(document).on('click', '#verify_admin_password', function() {
            ...
            $.ajax({
                url: "{{ route('healty-mind-verify-admin') }}",
                type: "POST",
                data: {
