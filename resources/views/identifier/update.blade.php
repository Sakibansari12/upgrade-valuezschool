                    ...
                    <form name="aimodulescreate" id="aimodulescreate" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="module_page_title" value="{{ $aimoduledata->module_page_title}}" id="module_page_title" class="form-control" placeholder="Module page title">
                           <p></p>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <img id="imagePreview" src="{{ url('uploads/Identifier') }}/{{ $aimoduledata->thumbnail ? $aimoduledata->thumbnail : 'no_image.png' }}"
                                    width="100px">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea  name="module_page_overview"  id="module_page_overview" rows="4" class="form-control" placeholder="Module Page Overview">{{ $aimoduledata->module_page_overview}}</textarea>
                               <p></p>
                            </div>
                            
                            <div class="form-group">
                                <label class="form-label">Video url <span class="text-danger">*</span></label>
                                <input type="text" name="video_url"  value="{{ $aimoduledata->video_url}}" id="video_url" class="form-control" placeholder="Video url">
                                <p></p>
                            </div>
