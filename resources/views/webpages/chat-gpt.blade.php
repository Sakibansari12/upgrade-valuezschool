            ...
            <h3><b>Let's watch {{ isset($formattedType) ? $formattedType : '' }} in action! Try the prompts below:</b></h3>
                    ...
                    <div class="faq-section">
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="faq-question">
                                <h5>{{ $key + 1 }}. <b> {{ isset($cdata->prompts) ? $cdata->prompts : '' }}</b></h5>
                    ...
                    <div class="info-section">
                        ...
                        @if (!empty($aimodules->activitiesdata))
                            ...
                            <li>
                                ...
                                <!-- <a href="#" target="_blank" class="waves-light btn " id="copyPrompt"><span class="fw-600"><i class="fa fa-copy"></i></span></a> -->
                                ...
                                <div id="imageContainer_{{$key+1}}" style="display: none;" class="mt-2">
                                <img class="video-btn"
                                        src="{{ url('uploads/aimodule') }}/{{ $cdata->prompt_screenshot ? $cdata->prompt_screenshot : 'no_image.png' }}"
                                        alt="Image" id="imageToShow_{{$key+1}}" style="max-width: 60%;" />
                    ...
                    <div class="faq-item">
                        ...
                        @if (!empty($aimodules->AddOwnactivitiesdata))
                            ...
                            <div class="col-md-4 mt-2" style="width: 18.333333%">
                                <a href="{{ isset($cdata->add_ai_toll_url) ? $cdata->add_ai_toll_url : '' }}" class="waves-effect waves-light btn" 
        ...
        button.disabled = true;
           ...
           $.ajax({
             ...
             success: function(response){
                ...
                var displayNextWord = function() {
                    if (index < words.length) {
                        $("#chatgptanswer").siblings('p').addClass('text-black').html(words.slice(0, index + 1).join(' '));
                        index++;
                    } else {
                        clearInterval(wordDisplayInterval);
                    }
