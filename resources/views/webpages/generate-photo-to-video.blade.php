...
<div class="col-xl-12">
    ...
    <hr>
            ...
            <h3><b>Click on "Generate video" to add life to the still photos</b></h3>
                            ...
                            <div class="row m-5">
                                ...
                                <div class="col-md-5" >
                                         <iframe 
                                            id="video_{{ $key + 1 }}"
                                            height="220"
                                            style="border-radius: 20px; display: none;  width:100%;height:100%; border-radius: 20px;"  src="{{ $cdata->prompts }}" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen ></iframe>
              ...
              <div class="faq-section">
                        ...
                        <div class="faq-item">
                            <div class="faq-question">
                            <h3><b>Add own image to convert to video</b></h3>
                            </div>
                        <div class="faq-question">
    ...
    $("#add-field-input").click(function() {
        ...
        var newRow =
            $(
                ...
                '<div class="faq-item" style="background-color:  #00205c;  color: #fff;">' +
                        '<input type="file" name="ask_photo_video" id="ask_photo_video_' + uniqueId + '" required style="font-size: 16px;" onchange="SecondplantImage(event,' + uniqueId + ')">'+
                        ...
                        '<video class="mediaPlayerOwn_' + uniqueId + '" controls autoplay loop></video>'+
                        '</div>'+
...
//console.log(button_new,"button_new");
        ...
        button_new.disabled = true;
            ...
            $.ajax({
                url: '{{ route("prompts-generate-photo-video") }}',
                type: 'post',
                data: formData,
                //dataType: 'json',
                processData: false, 
        contentType: false, 
            ...
            var videoElement = document.querySelector('.prompt_one_photo_video_'+ id, '.mediaPlayerOwn_'+ id);
            videoElement.src = videoUrl;
            videoElement.addEventListener('loadedmetadata', function() {
                videoElement.play();
            });
            var chatElement = document.querySelector('.prompt_one_photo_video'+ id);
...
function copyTextareaContent(key) {
    ...
    var videoElement = document.getElementById('video_' + key);
