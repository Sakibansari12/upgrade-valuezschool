                    ...
                    <div class="card-header">
                        ...
                        <div class="card-actions float-end">
                            <div class="dropdown show">
                                 <a href="{{ route('school-payment', ['school_id' => $school_id]) }}"
                                        id="export-link"
                                        class="btn btn-sm btn-outline mb-1">School Payment List</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    @foreach ($student_payment_data  as $key => $data)
                                        ...
                                        <td> <a href="javascript:void(0)" data-bs-toggle="modal"
                                         ...
                                         <td> 
                                            ...
                                            <td>
                                            <a href="{{ route('student-generate-invoice', ['student_payment_id' => $data->id]) }}" class="waves-effect waves-light btn btn-sm btn-outline btn-info mb-5">Generate Invoice</a>
