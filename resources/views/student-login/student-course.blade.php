                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('student.grade.list') }}" id="grade-name">{{ $class_name->class_name; }}</a></li>
                                ...
                                <div class="box">
                                    <div class="box-body">
                                        ...
                                        <div class="mt-30 pro-dec text-center">
                                            ...
                                            <div class="price-dle d-flex justify-content-center align-items-center">
                                                <a href="{{ route('student.lesson.list', ['classid' => $classId, 'course' => $cdata->course_id]) }}"
                                                    class="btn btn-sm me-2" style="background-color: #00205c; color: #fff;">View Instruction Modules</a>
                                            </div>
                                    ...
                                    <div class="box-footer">
                                        <div class="justify-content-around d-flex">
                                            ...
                                            <div class="ms-2">
                                                <button class="btn btn-xs  getProgress" style="background-color: #00205c; color: #fff;" data-bs-toggle="modal"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table id="yajra-table" class="table b-1" style="width:100%">
    ...
    <script language="javascript" type="text/javascript">
        $(function() {
            $('.getProgress').click(function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('student.grade.course.history') }}",
                    data: {
                        courseId: courseId,
                        classId: gradeId,
                    },
