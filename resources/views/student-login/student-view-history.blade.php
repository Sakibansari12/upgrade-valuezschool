            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        Your Module Completion History</h5>
                            
                            <form action="{{ route('student-view-history') }}" method="GET">
                                ...
                                @if(isset($studentreportsdata['student']) && is_array($studentreportsdata['student']))
                                    @foreach ($studentreportsdata['student'] as $key => $data)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>{{ isset($data->master_course_course_name) ? $data->master_course_course_name : '' }}</td>
                                            <td>{{ isset($data->lesson_plan_title) ? $data->lesson_plan_title : '' }}</td>
                                            <td>
                  ...
                  <div class="parent-milestone-second">
                    ...
                    <div>
                     ...
                     @foreach ($filtered_lesson_plan_second as $key => $data)
                        @if($data['id'] == 105)
                        <div >
                        <img src="{{ asset('assets_milestone/img/milestone/milestone_new.png') }}" class="img-fluid" style="height: 50%; max-width: 127%;" />
                        </div>
                        @endif 
                        @if($data['id'] == 108)
                        ...
                        @if($data['id'] == 108) 
                          <div style="max-width: 100px; height: auto;">
                            <img src="{{ asset('assets_milestone/img/Flag_folder/rockit.png') }}" class="img-fluid" alt=""   style="margin-top: 70px;">
                          </div>
                        @endif
