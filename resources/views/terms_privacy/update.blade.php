                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page">Update Terms & Privacy</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-lg-8 col-12">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Update Terms & Privacy</h4>
                    </div>
                    <!-- /.box-header -->
                    <form id="TermPrivacyUpdate" name="TermPrivacyUpdate" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <option {{ ($data->type == 'VALUEZ TERMS & CONDITIONS') ? 'selected' : '' }} value="VALUEZ TERMS & CONDITIONS">VALUEZ TERMS & CONDITIONS</option>
                                <option {{ ($data->type == 'PRIVACY POLICY') ? 'selected' : '' }} value="PRIVACY POLICY">PRIVACY POLICY</option>
                                </select>
                                <p></p>
                            </div>
                            ...
                            <input type="hidden" name="terms_privacy_id" id="terms_privacy_id" value="{{ $data->id }}">
...
@section('script-section')
    ...
    <script>
$('#TermPrivacyUpdate').submit(function (event) {
    event.preventDefault();
    var formData = new FormData(this);
    $.ajax({
        url: '{{ route("terms-privacy.update") }}',
        type: 'POST',
        processData: false,
        contentType: false,
        data: formData,
