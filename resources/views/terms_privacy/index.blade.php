                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active alignment-text-new" aria-current="page">Terms & Privacy</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Terms & Privacy</h5>
                        <div class="card-actions float-end">
                            <div class="dropdown show">
                                <a href="{{ route('terms-privacy.add') }}"
                                    class="waves-effect waves-light btn btn-sm btn-outline btn-info mb-5">Add Terms & Privacy</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
